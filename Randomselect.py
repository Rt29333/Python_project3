...
# Form implementation generated from reading ui file 'Randomselect.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background: rgb(144, 196, 200);\n"
"")
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(470, 340, 93, 41))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(20)
        font.setBold(True)
...
"background-color: rgb(85, 170, 255);")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("F:/图片/name.webp"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.pushButton_5 = QtWidgets.QPushButton(self.widget)
        self.pushButton_5.setGeometry(QtCore.QRect(170, 460, 93, 51))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(20)
        font.setBold(True)
